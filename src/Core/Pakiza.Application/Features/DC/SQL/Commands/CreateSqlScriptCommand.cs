...
public record CreateSqlScriptCommand(SqlScriptDTO SqlScript) : ICommand<CreateSqlScriptResult>;

public record CreateSqlScriptResult(Guid Id);

public class CreateSqlScriptCommandValidator : AbstractValidator<CreateSqlScriptCommand>
{
    public CreateSqlScriptCommandValidator()
    {
